...
namespace DiagramDesigner
{
    ...
    {
        public List<DesignerItem> childNodeItem = new List<DesignerItem>();
        public Connector LeftConnector = new Connector();
        public List<Connector> RightConnector = new List<Connector>();
        public List<MyTextBox> outputValue = new List<MyTextBox>();
        public ComboBox myCombo = null;
        public List<Connection> leftConnectionList = new List<Connection>();
        public List<Connection> rightConnectionList = new List<Connection>();
        #region ID
        private Guid id;
        public Guid ID
        {
